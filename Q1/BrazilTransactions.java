...
public class BrazilTransactions {
    public static void main(String[] args) throws Exception {
        ...
        j.setMapperClass(MapForBrazilTransactions.class);
        j.setReducerClass(ReduceForBrazilTransactions.class);
    ...
    public static class MapForBrazilTransactions extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context con)
            ...
            if (Objects.equals(pais, "Brazil"))con.write(new Text(pais),um);
            }
        }
    ...
    public static class ReduceForBrazilTransactions extends Reducer<Text, IntWritable, Text, IntWritable> {
        ...
        public void reduce(Text key, Iterable<IntWritable> values, Context con)
            ...
            for(IntWritable v : values){
                if(Objects.equals(key.toString(), "Brazil")){
                    soma += v.get();
                };
            }
